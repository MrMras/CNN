...
if not os.path.exists("./data/micro_ct"):
    os.makedirs("./data/micro_ct")

np.save("./data/micro_ct/volume_input.npy", filtered_arr_in)
np.save("./data/micro_ct/volume_ground_truth.npy", filtered_arr_out)